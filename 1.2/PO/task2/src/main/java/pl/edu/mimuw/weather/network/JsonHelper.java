...
public class JsonHelper {
    ...
    public static JsonObject findElement (JsonArray array, String key, int value) throws NoSuchFieldException {
        for (JsonElement e : array) {
            if (e.getAsJsonObject().get(key).getAsInt() == value)
                return e.getAsJsonObject();
        }
        throw new NoSuchFieldException("key string not found");
    }
